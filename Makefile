# Observability Lab — Build & Deployment
...
# Semconv and linting tool versions
...
.PHONY: clean-images
clean-images:
	@docker rmi $(shell docker images --filter=reference="observability-lab:latest-*" -q); \
    if [ $$? -ne 0 ]; \
    then \
    	echo; \
        echo "Failed to remove 1 or more images."; \
        echo "Check to ensure the platform is not running by executing: make stop"; \
        false; \
    fi
...
start:
	...
	@echo ""
	@echo "Observability Lab is running."
	@echo "Go to http://localhost:8080 for the Storefront."
...
start-minimal:
	...
	@echo ""
	@echo "Observability Lab (minimal mode) is running."
	@echo "Go to http://localhost:8080 for the Storefront."
	@echo "Go to http://localhost:8080/jaeger/ui for the Jaeger UI."
	@echo "Go to http://localhost:8080/grafana/ for the Grafana UI."
	@echo "Go to http://localhost:8080/loadgen/ for the Load Generator UI."
...
stop:
	...
	@echo ""
	@echo "Observability Lab is stopped."
